    ...
    referrals: [
      {
        name: "Charles Schwab",
        description:
          "One of the reasons I choose Schwab is their debit card has no ATM fees, domestically or internationally",
        bonus: "Up to $1,000",
      ...
      },
      {
        name: "SoFi",
        description:
          "An online bank that offers checking and savings accounts with no account fees or minimum balance requirements",
        bonus: "Up to $325",
    ...
    referrals: [
      {
        name: "Beli",
        description:
          "An app I use to save restaurants, write reviews, share recommendations, and remember where I want to eat",
...
const fullBonusByHref: Record<string, string> = {
  "https://i.capitalone.com/JrMpDJrTQ":
    "Earn 100,000 bonus miles after spending $10,000 on purchases in the first 6 months",
  "https://i.capitalone.com/JjtDtWZgs":
    "Earn a $100 REI gift card after your first purchase outside of REI within 60 days of account opening",
  "https://www.referyourchasecard.com/18d/CSJO5XQRI3":
    "Earn $200 or $300 cash back after spending $500 on purchases in the first 3 months",
  "https://get.venmo.com/7xWaniQM3Zb":
    "Earn $100 cash back after spending $500 on purchases in the first 3 months",
  "https://www.schwab.com/client-referral?refrid=REFEREUE4TERM":
    "Get up to $1,000 through this referral depending on your initial funding amount",
  "https://kalshi.com/sign-up/?referral=b758c4ef-2bc7-438b-ac4a-564f1ae0b567&m=true":
    "Sign up and we'll both get $25",
  ...
  return (
    <div className="mx-auto max-w-[1240px] px-5 py-10 sm:px-7">
      ...
      <header className="animate-fade-in mb-14">
        ...
        <p className="text-muted mt-6 max-w-[60ch] text-lg">
          Links to services I actually use. You get a bonus, I get a bonus. Win-win.
        </p>
      </header>
      ...
      <div className="space-y-16">
        {categories.map((category) => (
          <section key={category.name} className="animate-fade-in-delay-1">
            ...
            />
            <p className="font-mono-label text-muted mb-6 -mt-4">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col p-5">
                      <h3 className="font-display mb-2 text-xl tracking-tight uppercase">
                        {referral.name}
                      </h3>
                      ...
                      {fullBonus && referral.bonus && (
                        <p className="font-mono-label text-muted mt-4 text-[0.7rem] leading-snug normal-case tracking-normal">
                          {fullBonus}
                        </p>
                      )}
      ...
      {/* Footer note */}
      <p className="font-mono-label text-muted animate-fade-in-delay-3 mt-20 text-center">
